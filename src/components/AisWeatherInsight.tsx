...
const AisWeatherInsight = () => {
  ...
  return (
    <motion.div 
      ...
      className="bg-[#1A1A1A] border border-[rgba(200,255,0,0.2)] rounded-2xl p-6 flex flex-col md:flex-row items-center gap-6 shadow-[0_0_30px_rgba(200,255,0,0.05)]"
    >
      <div className="flex items-center gap-4 border-r border-white/5 pr-6">
        <div className="w-12 h-12 bg-[#C8FF00]/10 rounded-xl flex items-center justify-center">
          <Cloud className="w-7 h-7 text-[#C8FF00]" />
        </div>
      ...
      <div className="flex-1 flex items-center gap-3">
        <Sparkles className="w-5 h-5 text-[#C8FF00] shrink-0" />
      ...
      <div className="hidden lg:flex flex-col items-end gap-1">
        <span className="text-[#C8FF00] text-[10px] font-bold tracking-[0.2em] uppercase">AI 推送</span>
